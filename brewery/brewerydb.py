...
"""
This is a wrapper class that supports the BreweryDB API. It wraps all of the GET requests contained in the API
Code taken from https://github.com/yarian/brewerydb
Full credit attributed to Yarian Gomez
"""
